...
export function MapPreview() {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
      <Link
        href="/s"
        className="block relative w-full h-48 sm:h-64 rounded-2xl overflow-hidden group bg-slate-100"
      >
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 transition-transform duration-500 group-hover:scale-105" />
