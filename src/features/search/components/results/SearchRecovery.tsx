...
export function SearchRecovery() {
  ...
  return (
    <div className="py-12 flex flex-col items-center justify-center text-center w-full max-w-xl mx-auto my-auto">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {recovery.actions
                ...
                .map((action, idx) => (
                  <button
                    key={idx}
                    className="px-4 py-2 border border-gray-300 rounded-full text-sm font-medium text-gray-700 hover:border-gray-900 transition-colors"
                  >
                    {action.title}
                  </button>
                ))}
